...
urlpatterns = [
    ...
    path('products/create/', adminapp.ProductCreateViev.as_view(), name='product_create'),
    path('products/read/category/<int:category_pk>/', adminapp.ProductListViev.as_view(), name='products_by_category'),
    path('products/read/', adminapp.ProductListViev.as_view(), name='products'),
    path('products/read/<int:pk>/', adminapp.ProductDetailViev.as_view(), name='product_read'),
    path('products/update/<int:pk>/', adminapp.ProductUpdateViev.as_view(), name='product_update'),
    path('products/delete/<int:pk>/', adminapp.ProductDeleteViev.as_view(), name='product_delete'),
]
